package com.user.yemektarifleri
...
class TarifFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        arguments?.let {
            ...
            if (gelenBilgi.equals("menudengeldim")){
                ...
                val gorselSecmeArkaPlanı = BitmapFactory.decodeResource(context?.resources, R.drawable.image)
    ...
    fun kucukBitmapOlustur(kullanicininSectigiBitmap: Bitmap, maximumBoyut: Int) : Bitmap {
        ...
        if (bitmapOrani > 1 )
        {   // gorsel yatay orn: 100/200 eger 100->50 olacaksa 200->100 olmalı
            width= maximumBoyut
            val kisaltilmisHeight= width / bitmapOrani //orn 50 / (1/2)
